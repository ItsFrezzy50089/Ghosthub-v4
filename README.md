--You can use this code Also I help people So they know How to code.
--Made by ItsFrezzy

--Login Gui
local ScreenGui = Instance.new("ScreenGui")
local LoginFrame = Instance.new("Frame")
local LoginFrame2 = Instance.new("Frame")
local LoginLabel1 = Instance.new("TextLabel")
local UserLabel = Instance.new("TextBox")
local Passlabel = Instance.new("TextBox")
...
LoginFrame.Position = UDim2.new(0.13103953, 0, 0.343589246, 0)
LoginFrame.Selectable = true
LoginFrame.Size = UDim2.new(0, 392, 0, 463)
LoginFrame.Active = true
LoginFrame.Draggable = true
 
LoginFrame2.Name = "Login Frame 2"
LoginFrame2.Parent = LoginFrame
LoginFrame2.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
LoginFrame2.BorderColor3 = Color3.fromRGB(0, 0, 0)
LoginFrame2.Position = UDim2.new(0.010309278, 0, 0, 0)
LoginFrame2.Size = UDim2.new(0, 384, 0, 17)
 
LoginLabel1.Name = "Login Label 1"
LoginLabel1.Parent = LoginFrame
LoginLabel1.BackgroundColor3 = Color3.fromRGB(5, 5, 5)
LoginLabel1.BorderColor3 = Color3.fromRGB(15, 15, 15)
LoginLabel1.BorderSizePixel = 0
LoginLabel1.Position = UDim2.new(0.141083777, 0, 0.0863930881, 0)
LoginLabel1.Size = UDim2.new(0, 275, 0, 32)
LoginLabel1.Font = Enum.Font.SciFi
LoginLabel1.Text = "GhostHub||Login "
LoginLabel1.TextColor3 = Color3.fromRGB(255, 255, 255)
LoginLabel1.TextSize = 37.000
 
UserLabel.Name = "UserLabel"
UserLabel.Parent = LoginFrame
UserLabel.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
UserLabel.BorderColor3 = Color3.fromRGB(10, 10, 10)
UserLabel.BorderSizePixel = 4
UserLabel.Position = UDim2.new(0.124052659, 0, 0.337240785, 0)
UserLabel.Size = UDim2.new(0, 301, 0, 33)
...
Passlabel.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
Passlabel.BorderColor3 = Color3.fromRGB(10, 10, 10)
Passlabel.BorderSizePixel = 4
Passlabel.Position = UDim2.new(0.124052659, 0, 0.530154943, 0)
Passlabel.Size = UDim2.new(0, 301, 0, 35)
...
Loginbutton.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
Loginbutton.BorderColor3 = Color3.fromRGB(255, 255, 255)
Loginbutton.BorderSizePixel = 4
Loginbutton.Position = UDim2.new(0.214955449, 0, 0.671706259, 0)
Loginbutton.Size = UDim2.new(0, 231, 0, 84)
...
Loginbutton.MouseButton1Down:connect(function()
	--Yes you can look at the coding I don't care
--Made by ItsFrezzy Make sure to Credit me...
--Activate Hub GUI
...
Main1.Position = UDim2.new(0.102272727, 0, 0.442424238, 0)
Main1.Size = UDim2.new(0, 392, 0, 210)
Main1.Active = true
...
Label1.BorderColor3 = Color3.fromRGB(255, 255, 255)
Label1.Position = UDim2.new(0.0967741907, 0, 0, 0)
Label1.Size = UDim2.new(0, 324, 0, 25)
Label1.Font = Enum.Font.SciFi
Label1.Text = "[Ghost Hub v4 Testing] |Made by ItsFrezzy"
Label1.TextColor3 = Color3.fromRGB(255, 255, 255)
Label1.TextSize = 17.000
 
Button1.Name = "Button1"
Button1.Parent = Main1
Button1.BackgroundColor3 = Color3.fromRGB(5, 5, 5)
Button1.BorderColor3 = Color3.fromRGB(255, 255, 255)
Button1.Position = UDim2.new(0.0846457705, 0, 0.204761907, 0)
Button1.Size = UDim2.new(0, 333, 0, 138)
Button1.Font = Enum.Font.SourceSans
Button1.Text = "Activate Hub!"
Button1.TextColor3 = Color3.fromRGB(255, 255, 255)
Button1.TextSize = 25.000
Button1.MouseButton1Down:connect(function()
 --Gui Don't touch
local Library = loadstring(game:HttpGet("https://pastebin.com/raw/vff1bQ9F"))()
local Window = Library.CreateLib("Ghost Bedwars Hub 4v", "BloodTheme")
